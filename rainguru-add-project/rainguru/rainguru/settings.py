"""
Django settings for rainguru project.
...
SECRET_KEY = 'django-insecure-i(v_o43lfse(w+_wn3k!*qa7u@mn1_@-a6xx@xh%*xi_t-%5ew'
...
# Set the value of GZIP_CONTENT_TYPES to include JavaScript and CSS files
GZIP_CONTENT_TYPES = (
    'text/css',
    'text/javascript',
)
